...
**Goal (per rubric):** show what the viz *does* in a fun, engaging, impactful way — talk about **contributions and insights**, *not* technical details.
...
| **1:08–1:24** | **Concentration.** Show Lorenz curve + Gini; hover once; then click **"Token coverage."** | "But the web isn't fair. A handful of domains dominate — a Gini of nearly point-six. In fact, just **three hundred domains** supply a quarter of *all* the text a model reads." |
...
- **The funnel reveal** is the signature moment — give it room.
